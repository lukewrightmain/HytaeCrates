...
import com.hytalecrates.animation.ParticleEffect;
import com.hytalecrates.animation.SoundEffect;
import com.hytalecrates.animation.SpinAnimation;
...
public class CrateSpinGUI {
    ...
    private void announceWin(Reward wonReward) {
        ...
        String format;
        if (wonReward.getRarity() == com.hytalecrates.reward.Rarity.LEGENDARY) {
